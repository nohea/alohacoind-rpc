...
alohacoind-rpc.js runs on [node](http://nodejs.org/), and can be installed via [npm](https://npmjs.org/):

```bash
npm install alohacoind-rpc
```
...
var run = function() {
  ...
  var RpcClient = require('alohacoind-rpc');
